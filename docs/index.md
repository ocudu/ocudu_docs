...
<div style={{display: 'flex', gap: '2.5rem', alignItems: 'center', marginBottom: '2.5rem', flexWrap: 'wrap'}}>
  <div style={{flex: '1', minWidth: '280px'}}>
    ...
    <p>OCUDU is an open-source 5G gNB implementing the full CU and DU protocol stack. It is designed for commercial deployment and research, and runs on general-purpose x86 and ARM hardware.</p>
  ...
  <div style={{flexShrink: '0', width: '40%', minWidth: '240px'}}>
    <img
      src={useBaseUrl('/img/oran_gnb_arch.jpg')}
