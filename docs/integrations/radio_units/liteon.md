---
description: "Connecting a LITEON FlexFi O-RAN radio unit to OCUDU over the split 7.2 Open Fronthaul interface."
---
...
You can download a sample gNB configuration file that is compatible with the LITEON FlexFI RU [here](assets/gnb_ru_liteon_tdd_n78_100mhz.yml).
