<a id="oran-gnb-components"></a>

# O-RAN gNB Components

As outlined in the [O-RAN gNB Overview](../../oran_gnb/source/index.md#oran-gnb-overview) the 5G NR gNB introduces a flexible architecture. Splitting the gNB into the CU, DU and RU.
...
![image](knowledge_base/source/gnb_components/source/.imgs/CU.png)
...
![image](knowledge_base/source/gnb_components/source/.imgs/DU.png)
