<a id="oran-gnb-interfaces"></a>

# gNB Interfaces

As outlined in the [O-RAN gNB Overview](../../oran_gnb/source/index.md#oran-gnb-overview) the 5G NR gNB introduces a flexible architecture. Splitting the gNB and introducing multiple new interfaces.
...
![image](knowledge_base/source/gnb_interfaces/source/.imgs/FrontHaul.png)
...
![image](knowledge_base/source/gnb_interfaces/source/.imgs/FrontHaul_flow.png)
