...
- [OCUDU](https://gitlab.com/ocudu/ocudu) (26.04 or later)
...
- [GNU-Radio Companion](https://www.gnuradio.org/) (used for a NTN channel emulator)
...
For further details, please refer to the [Amarisoft website](https://www.amarisoft.com/).
...
Important details of the modifications made are outlined in the following sections. The description of the remaining config parameters is available in [Configuration Reference](../../user_manual/config_reference/config_reference.mdx).
