...
- [`4x2 MIMO configuration with 100 MHz bandwidth`](.configs/ru_config.cfg).
...
- [`UE configuration (2x2 MIMO configuration with 20 MHz bandwidth)`](.configs/amariUE_R550_20mhz_2x2.cfg).
