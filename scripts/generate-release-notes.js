...
// Generates docs/releases/release_notes.md from the CHANGELOG in the cloned OCUDU repo.
...
const outputPath = path.resolve(__dirname, '../docs/releases/release_notes.md');
...
console.log('[release-notes] Generated docs/releases/release_notes.md from docs/ocudu/CHANGELOG.');
